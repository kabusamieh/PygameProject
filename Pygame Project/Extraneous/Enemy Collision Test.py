...
class Bkgr(pygame.sprite.Sprite):
    def __init__(self, i):                      
        ...
        self.image, self.rect = pygame.image.load("Bkgr.png")
...
class Enemy(pygame.sprite.Sprite):
    def __init__(self, centerx):
        ...
        self.i = pygame.load.image("enemy.png", -1)
...
class EnemyExplosion(pygame.sprite.Sprite):
    def __init__(self, pos):
        ...
        self.i = pygame.image.load("enemyexplosion.png", -1)
...
class PlayerExplosion(pygame.sprite.Sprite):
    def __init__(self, pos):
        ...
        self.i = pygame.load.image("enemyexplosion.png", -1)
        self.rect.center = pos        
        self.counter = 0
        self.maxcount = 10
